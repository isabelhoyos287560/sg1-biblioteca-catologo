...
{
    public sealed class GetAllBooksHandler : IRequestHandler<GetAllBooksQuery, List<BookListDto>>
    {
        ...
        public async Task<List<BookListDto>> HandleAsync(GetAllBooksQuery request, CancellationToken cancellationToken)
        {
